...
io.on('connection', (socket) => {
  ...
  socket.on('updateGameState', (data) => {
    ...
    // ✅ ADD THESE DECK UPDATES
    if (data.p1UserId !== undefined) room.p1UserId = data.p1UserId;
    if (data.p2UserId !== undefined) room.p2UserId = data.p2UserId;
    if (data.p1Deck !== undefined) room.p1Deck = data.p1Deck;
    if (data.p2Deck !== undefined) room.p2Deck = data.p2Deck;
